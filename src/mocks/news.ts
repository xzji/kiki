...
export const newsArticles: Article[] = [
  {
    ...
    body: "OpenAI 在今天的开发者活动中展示了一套面向企业场景的多智能体协作框架。该框架强调任务分解、计划回退、价值门控与用户确认节点，特别适合需要长期目标推进的产品。文章指出，未来的产品形态不再是单轮问答，而是持续执行和阶段汇报。对 Dora 这类目标驱动型自主 Agent 来说，重点在于如何把后台复杂推理压缩成对用户可感知的少量高价值反馈。",
  },
  {
    id: "news-2",
