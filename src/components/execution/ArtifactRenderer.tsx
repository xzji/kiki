...
export function ArtifactRenderer({ refs, hasInteractiveSurface }: { refs?: ArtifactRef[]; hasInteractiveSurface?: boolean }) {
...
export function ArtifactRefList({ refs, hasInteractiveSurface }: { refs?: ArtifactRef[]; hasInteractiveSurface?: boolean }) {
  return <ArtifactRenderer refs={refs} hasInteractiveSurface={hasInteractiveSurface} />;
}
